...
def build_bilstm_model(input_shape):
    ...
    """
    Xây dựng một mạng Bidirectional LSTM cơ bản
    """
...
def main():
    ...
    plt.title('Độ mất mát (Loss) của Model BiLSTM qua các Epochs')
    plt.xlabel('Epochs')
    plt.ylabel('Loss')
    plt.legend()
    plt.show()
    ...
    plt.plot(predictions_denorm[:500], label='Dự đoán (Predictions) - BiLSTM', color='red', alpha=0.7)
    plt.title('Dự đoán lưu lượng giao thông BiLSTM vs Thực tế')
